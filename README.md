# Business Intelligence - Guía de Trabajos Prácticos con R ^4.0.1
...
<code> C:\Program Files\R\R-4.0.1\library\base\R </code>
...
9) Actualizar los compiladores requeridos por R ^4.0.1 con las instrucciones del siguiente tutorial (MacOs Catalina 10.15+):
...
<code> sudo nano /usr/local/Cellar/r/4.0.1/lib/R/library/base/R/Rprofile </code> Hay que buscarlo con Finder. 
