...
<code> C:\Program Files\R\R-4.0.2\library\base\R </code>
...
9) Actualizar los compiladores requeridos por R ^4.0.2 con las instrucciones del siguiente tutorial (MacOs Catalina 10.15+):
...
<code> sudo nano /usr/local/Cellar/r/4.0.2/lib/R/library/base/R/Rprofile </code> Hay que buscarlo con Finder. 
