...
La gira que se encuentra en este ejemplo nos da un camino desde Hilo, Hawaii a San Juan de Puerto Rico. Un camino de este tipo también se puede visualizar mediante el uso los paquetes sp, mapas y MapTools (Pebesma y Bivand 2005).
...
load(file = "/Users/martin/OneDrive/Documents/myLearning/UTN/BI with R/BI Labs with R/6. Algoritmos Geneticos - El Vendedor Viajante/USCA312_map.rda")
...
Mirando la ruta completa, vemos que los "boundary" están en los indices de posiciones [41], [168], [176], [178], [180], [182], [196], [200], y [202]. Por ende, 9 boundaries no dan 10 clusters:
